...
ln -s $HOME/.dot-files/_pspgconf $HOME/.pspgconf
...
ln -s $HOME/.dot-files/_hammerspoon $HOME/.hammerspoon
...
defaults write com.knollsoft.Rectangle screenEdgeGapTopNotch -int 45
