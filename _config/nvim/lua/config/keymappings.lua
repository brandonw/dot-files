...
keymap('n', 'gss', ':terminal npm run api:no-watch<CR>')
keymap('n', 'gsr', ':terminal npm run app<CR>:tabnew<CR>:terminal npm run worker:no-watch<CR>:tabnew<CR>:terminal npm run scheduler:no-watch<CR>:tabnew<CR>:terminal npm run customer-data-worker:no-watch<CR>')
