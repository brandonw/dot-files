...
keymap("n", "gss", ":tabnew | terminal npm run swc:dev api<CR>")
keymap("n", "gsr", ":tabnew | terminal npm run app<CR>:tabnew<CR>:terminal npm run swc:dev worker<CR>:tabnew<CR>:terminal npm run swc:dev scheduler<CR>:tabnew<CR>:terminal npm run swc:dev customer-data-worker<CR>")
