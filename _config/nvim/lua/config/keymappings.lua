...
keymap('n', 'gss', ':terminal npm run api<CR>')
keymap('n', 'gsr', ':terminal npm run app<CR>:tabnew<CR>:terminal npm run worker<CR>:tabnew<CR>:terminal npm run scheduler<CR>:tabnew<CR>:terminal npm run customer-data-worker<CR>')
